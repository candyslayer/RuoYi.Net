...
CREATE TABLE sys_dept (dept_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, parent_id BIGINT DEFAULT 0, ancestors VARCHAR(50) DEFAULT '', dept_name VARCHAR(30) DEFAULT '', order_num INT DEFAULT 0, leader VARCHAR(20) DEFAULT NULL, phone VARCHAR(11) DEFAULT NULL, email VARCHAR(50) DEFAULT NULL, status CHAR(1) DEFAULT '0', del_flag CHAR(1) DEFAULT '0', create_by VARCHAR(64) DEFAULT '', create_time TIMESTAMP, update_by VARCHAR(64) DEFAULT '', update_time TIMESTAMP, PRIMARY KEY (dept_id));

/* ---------------------------- */ /* 初始化-部门表数据 */ /* ---------------------------- */ INSERT INTO sys_dept VALUES (100, 0, '0', '若依科技', 0, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', CURRENT_TIMESTAMP, '', NULL);
...
CREATE TABLE sys_user (user_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, dept_id BIGINT DEFAULT NULL, user_name VARCHAR(30) NOT NULL, nick_name VARCHAR(30) NOT NULL, user_type VARCHAR(2) DEFAULT '00', email VARCHAR(50) DEFAULT '', phonenumber VARCHAR(11) DEFAULT '', sex CHAR(1) DEFAULT '0', avatar VARCHAR(100) DEFAULT '', password VARCHAR(100) DEFAULT '', status CHAR(1) DEFAULT '0', del_flag CHAR(1) DEFAULT '0', login_ip VARCHAR(128) DEFAULT '', login_date TIMESTAMP, create_by VARCHAR(64) DEFAULT '', create_time TIMESTAMP, update_by VARCHAR(64) DEFAULT '', update_time TIMESTAMP, remark VARCHAR(500) DEFAULT NULL, PRIMARY KEY (user_id));

/* ---------------------------- */ /* 初始化-用户信息表数据 */ /* ---------------------------- */ INSERT INTO sys_user VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '0192023a7bbd73250516f069df18b500', '0', '0', '127.0.0.1', CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP, '', NULL, '管理员');

INSERT INTO sys_user VALUES (2, 105, 'ry', '若依', '00', 'ry@qq.com', '15666666666', '1', '', '0192023a7bbd73250516f069df18b500', '0', '0', '127.0.0.1', CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP, '', NULL, '测试员');

/* ---------------------------- */ /* 3、岗位信息表 */ /* ---------------------------- */ DROP TABLE IF EXISTS sys_post;

CREATE TABLE sys_post (post_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, post_code VARCHAR(64) NOT NULL, post_name VARCHAR(50) NOT NULL, post_sort INT NOT NULL, status CHAR(1) NOT NULL, create_by VARCHAR(64) DEFAULT '', create_time TIMESTAMP, update_by VARCHAR(64) DEFAULT '', update_time TIMESTAMP, remark VARCHAR(500) DEFAULT NULL, PRIMARY KEY (post_id));

/* ---------------------------- */ /* 初始化-岗位信息表数据 */ /* ---------------------------- */ INSERT INTO sys_post VALUES (1, 'ceo', '董事长', 1, '0', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
CREATE TABLE sys_menu (menu_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, menu_name VARCHAR(50) NOT NULL, parent_id BIGINT DEFAULT 0, order_num INT DEFAULT 0, path VARCHAR(200) DEFAULT '', component VARCHAR(255) DEFAULT NULL, query VARCHAR(255) DEFAULT NULL, is_frame INT DEFAULT 1, is_cache INT DEFAULT 0, menu_type CHAR(1) DEFAULT '', visible CHAR(1) DEFAULT 0, status CHAR(1) DEFAULT 0, perms VARCHAR(100) DEFAULT NULL, icon VARCHAR(100) DEFAULT '#', create_by VARCHAR(64) DEFAULT '', create_time TIMESTAMP, update_by VARCHAR(64) DEFAULT '', update_time TIMESTAMP, remark VARCHAR(500) DEFAULT '', PRIMARY KEY (menu_id));

/* ---------------------------- */ /* 初始化-菜单信息表数据 */ /* ---------------------------- */ /* 一级菜单 */ INSERT INTO sys_menu VALUES ('1', '系统管理', '0', '1', 'system', NULL, '', 1, 0, 'M', '0', '0', '', 'system', 'admin', CURRENT_TIMESTAMP, '', NULL, '系统管理目录');
...
/* 二级菜单 */ INSERT INTO sys_menu VALUES ('100', '用户管理', '1', '1', 'user', 'system/user/index', '', 1, 0, 'C', '0', '0', 'system:user:list', 'user', 'admin', CURRENT_TIMESTAMP, '', NULL, '用户管理菜单');
...
/* 三级菜单 */ INSERT INTO sys_menu VALUES ('500', '操作日志', '108', '1', 'operlog', 'monitor/operlog/index', '', 1, 0, 'C', '0', '0', 'monitor:operlog:list', 'form', 'admin', CURRENT_TIMESTAMP, '', NULL, '操作日志菜单');
...
/* 用户管理按钮 */ INSERT INTO sys_menu VALUES ('1000', '用户查询', '100', '1', '', '', '', 1, 0, 'F', '0', '0', 'system:user:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
/* 角色管理按钮 */ INSERT INTO sys_menu VALUES ('1007', '角色查询', '101', '1', '', '', '', 1, 0, 'F', '0', '0', 'system:role:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
/* 菜单管理按钮 */ INSERT INTO sys_menu VALUES ('1012', '菜单查询', '102', '1', '', '', '', 1, 0, 'F', '0', '0', 'system:menu:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
/* 部门管理按钮 */ INSERT INTO sys_menu VALUES ('1016', '部门查询', '103', '1', '', '', '', 1, 0, 'F', '0', '0', 'system:dept:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
/* 岗位管理按钮 */ INSERT INTO sys_menu VALUES ('1020', '岗位查询', '104', '1', '', '', '', 1, 0, 'F', '0', '0', 'system:post:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
/* 字典管理按钮 */ INSERT INTO sys_menu VALUES ('1025', '字典查询', '105', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:dict:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
/* 参数设置按钮 */ INSERT INTO sys_menu VALUES ('1030', '参数查询', '106', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:config:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
/* 通知公告按钮 */ INSERT INTO sys_menu VALUES ('1035', '公告查询', '107', '1', '#', '', '', 1, 0, 'F', '0', '0', 'system:notice:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
/* 操作日志按钮 */ INSERT INTO sys_menu VALUES ('1039', '操作查询', '500', '1', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:operlog:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
/* 登录日志按钮 */ INSERT INTO sys_menu VALUES ('1042', '登录查询', '501', '1', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:logininfor:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
/* 在线用户按钮 */ INSERT INTO sys_menu VALUES ('1046', '在线查询', '109', '1', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:online:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
/* 定时任务按钮 */ INSERT INTO sys_menu VALUES ('1049', '任务查询', '110', '1', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:job:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
/* 代码生成按钮 */ INSERT INTO sys_menu VALUES ('1055', '生成查询', '116', '1', '#', '', '', 1, 0, 'F', '0', '0', 'tool:gen:query', '#', 'admin', CURRENT_TIMESTAMP, '', NULL, '');
...
CREATE TABLE sys_role_dept (role_id BIGINT NOT NULL, dept_id BIGINT NOT NULL, PRIMARY KEY (role_id, dept_id));
...
CREATE TABLE sys_user_post (user_id BIGINT NOT NULL, post_id BIGINT NOT NULL, PRIMARY KEY (user_id, post_id));
...
CREATE TABLE sys_oper_log (oper_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, title VARCHAR(50) DEFAULT '', business_type INT DEFAULT 0, method VARCHAR(100) DEFAULT '', request_method VARCHAR(10) DEFAULT '', operator_type INT DEFAULT 0, oper_name VARCHAR(50) DEFAULT '', dept_name VARCHAR(50) DEFAULT '', oper_url VARCHAR(255) DEFAULT '', oper_ip VARCHAR(128) DEFAULT '', oper_location VARCHAR(255) DEFAULT '', oper_param VARCHAR(2000) DEFAULT '', json_result VARCHAR(2000) DEFAULT '', status INT DEFAULT 0, error_msg VARCHAR(2000) DEFAULT '', oper_time TIMESTAMP, cost_time BIGINT DEFAULT 0, PRIMARY KEY (oper_id), INDEX idx_sys_oper_log_bt (business_type NULLS FIRST), INDEX idx_sys_oper_log_s (status NULLS FIRST), INDEX idx_sys_oper_log_ot (oper_time NULLS FIRST));
